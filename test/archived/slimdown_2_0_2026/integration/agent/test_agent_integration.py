...
- ✅ Real agent classes (HybridAgent, HybridAgent)
...
# ==================== Test 2.11.1: HybridAgent with All Features ====================


@pytest.mark.asyncio
async def test_knowledge_aware_agent_with_all_features(graph_store, context_engine):
    """
    Test 2.11.1: Test HybridAgent with all new features.

    Verifies that HybridAgent works with:
    - Custom LLM client
    ...
    # Create HybridAgent with all features
...
async def test_agent_with_all_features_combined(graph_store, context_engine):
    ...
    Combines: HybridAgent + ContextEngine + ConfigManager +

...
celery_app.conf.update(
    ...
    task_routes={
        'app.tasks.worker.execute_task': {'queue': 'fast_tasks'},
        'app.tasks.worker.execute_heavy_task': {'queue': 'heavy_tasks'}
    }
)
...
@celery_app.task(bind=True, name="app.tasks.worker.execute_heavy_task")

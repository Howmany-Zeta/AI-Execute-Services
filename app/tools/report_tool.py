...
from app.tools.temp_file_manager import TempFileManager
...
class ReportTool(BaseTool):
    """
    Multi-format report generation tool supporting HTML, PDF, Excel, PowerPoint, Markdown, Word, and image-based reports.

    Operations:
      - generate_html: Render HTML report using Jinja2.
      - generate_pdf: Generate PDF from HTML using WeasyPrint.

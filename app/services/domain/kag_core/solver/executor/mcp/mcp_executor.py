...
from app.services.domain.kag_core.interface import ExecutorABC, LLMClient, Context, PromptABC
from app.services.domain.kag_core.solver.executor.mcp.mcp_client import MCPClient
...
class McpExecutor(ExecutorABC):
    ...
    def download_data(self, input: str, **kwargs):
        ...
        if input.startswith("http://") or input.startswith("https://"):
            from app.services.domain.kag_core.common.utils import download_from_http

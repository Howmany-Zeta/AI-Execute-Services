...
from app.services.domain.kag_core.interface import SolverPipelineABC

from app.services.domain.kag_core.common.conf import KAG_CONFIG, KAG_PROJECT_CONF
from app.services.domain.kag_core.solver.reporter.open_spg_reporter import OpenSPGReporter
...
if __name__ == "__main__":
    from app.services.domain.kag_core.bridge.spg_server_bridge import init_kag_config

...
from app.core.interface.execution_interface import ExecutionInterface

# Import shared models
from app.domain.execution.model import TaskStepResult, TaskStatus, ErrorCode

# Import specialized managers
from app.infrastructure.monitoring.executor_metrics import ExecutorMetrics
from app.infrastructure.persistence.database_manager import DatabaseManager
from app.infrastructure.messaging.websocket_manager import WebSocketManager, UserConfirmation
from app.infrastructure.messaging.celery_task_manager import CeleryTaskManager
from app.application.executors.operation_executor import OperationExecutor
from app.domain.task.dsl_processor import DSLProcessor
from app.infrastructure.monitoring.tracing_manager import TracingManager
...
class ServiceExecutor(ExecutionInterface):
    ...
    def evaluate_condition(self, condition: str, intent_categories: List[str],
                          ...
                          results: List = None) -> bool:
        """评估条件"""
        return self.dsl_processor.evaluate_condition(condition, intent_categories, context, input_data, results)

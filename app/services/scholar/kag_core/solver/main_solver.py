...
from app.services.scholar.kag_core.interface import SolverPipelineABC

from app.services.scholar.kag_core.common.conf import KAG_CONFIG, KAG_PROJECT_CONF
from app.services.scholar.kag_core.solver.reporter.open_spg_reporter import OpenSPGReporter
...
def load_yaml_files_from_conf_dir():
    ...
    conf_dir = os.path.join(project_root, "app", "services", "domain", "kag_configs", "solver", "pipelineconf")
...
if __name__ == "__main__":
    from app.services.scholar.kag_core.bridge.spg_server_bridge import init_kag_config

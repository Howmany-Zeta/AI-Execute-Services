...
from app.services.scholar.kag_core.common.conf import KAG_CONFIG, KAG_PROJECT_CONF
from app.services.scholar.kag_core.common.config import LogicFormConfiguration
from app.services.scholar.kag_core.common.text_sim_by_vector import TextSimilarity
from app.services.scholar.kag_core.interface import Task, VectorizeModelABC
from app.services.scholar.kag_core.interface.solver.base_model import LogicNode
from app.services.scholar.kag_core.interface.solver.model.schema_utils import SchemaUtils
from app.services.scholar.kag_core.interface.solver.reporter_abc import ReporterABC
from app.services.scholar.kag_core.interface.solver.model.one_hop_graph import ChunkData
from app.services.scholar.kag_core.solver.executor.retriever.local_knowledge_base.kag_retriever.kag_component.flow_component import (
    FlowComponentTask,
    FlowComponent,
)
from app.services.scholar.kag_core.solver.executor.retriever.local_knowledge_base.kag_retriever.kag_component.kag_lf_cmponent import (
    KagLogicalFormComponent,
)
from app.services.scholar.kag_core.solver.executor.retriever.local_knowledge_base.kag_retriever.utils import (
    generate_step_query,
    get_all_docs_by_id,
)

from app.services.scholar.kag_core.tools.algorithm_tool.chunk_retriever.vector_chunk_retriever import (
    VectorChunkRetriever,
)
from app.services.scholar.kag_core.tools.graph_api.graph_api_abc import GraphApiABC
from app.services.scholar.kag_core.tools.search_api.search_api_abc import SearchApiABC

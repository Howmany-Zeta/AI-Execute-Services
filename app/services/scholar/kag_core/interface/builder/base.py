...
from app.services.scholar.kag_core.common.checkpointer import CheckPointer, CheckpointerManager
from app.services.scholar.kag_core.common.sharding_info import ShardingInfo
...
class BuilderComponent(Component, Registrable):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if rank is None or world_size is None:
            from app.services.scholar.kag_core.common.env import get_rank, get_world_size

...
import os
import json
from app.services.scholar.kag_core.builder.model.chunk import Chunk
from app.services.scholar.kag_core.builder.model.sub_graph import SubGraph
import kag.interface as interface
from app.services.scholar.kag_core.common.conf import KAGConstants, init_env
import logging
...
def collect_reader_outputs(data):
    ...
    def collect(data):
        from app.services.scholar.kag_core.interface.builder.base import BuilderComponentData
...
class SPGServerBridge:
    ...
    def run_llm_config_check(self, llm_config):
        from app.services.scholar.kag_core.common.llm.llm_config_checker import LLMConfigChecker

        return LLMConfigChecker().check(llm_config)

    def run_vectorizer_config_check(self, vec_config):
        from app.services.scholar.kag_core.common.vectorize_model.vectorize_model_config_checker import (
    ...
    def run_builder(self, config, input):
        from app.services.scholar.kag_core.builder.main_builder import BuilderMain
    ...
    def run_solver(
        ...
        from app.services.scholar.kag_core.solver.main_solver import SolverMain

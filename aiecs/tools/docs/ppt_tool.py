...
class PPTTool(BaseTool):
    ...
    class Config(BaseSettings):
        ...
        mcp_base_url: str = Field(default="http://localhost:5000", description="Base URL of banana-slides MCP server")
    ...
    def __init__(self, config: Optional[Dict] = None, **kwargs):
        ...
        self.config: PPTTool.Config = cast(
            PPTTool.Config,
    ...
    class Image_editSchema(BaseModel):
        ...
        context_images: Optional[List[Dict[str, Any]]] = Field(
            default=None, description='Optional list of base64-encoded images with format: [{"file_data": "base64...", "filename": "image.png"}, ...]'
        )

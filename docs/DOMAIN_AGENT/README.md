...
### 2a. [MIGRATION_CHECKLIST.md](./MIGRATION_CHECKLIST.md) - Migration Checklist ✅
...
### 2b. [UPGRADE_GUIDE.md](./UPGRADE_GUIDE.md) - Upgrade Guide with Examples 📖
...
### 2d. [BREAKING_CHANGES_ANALYSIS.md](./BREAKING_CHANGES_ANALYSIS.md) - Breaking Changes Analysis 🔍
...
### 17. [MULTI_AGENT_DESIGN.md](./MULTI_AGENT_DESIGN.md) - Multi-Agent System Design 🏗️
...
### 19. [MASTERCONTROLLER_MIGRATION.md](./MASTERCONTROLLER_MIGRATION.md) - MasterController Migration 🔀
...
3. **Migration (if needed)**: See [MIGRATION_GUIDE.md](./MIGRATION_GUIDE.md) if you have existing code

### For Existing Users

1. **Check Migration Guide**: See [MIGRATION_GUIDE.md](./MIGRATION_GUIDE.md) - good news: no migration required!
...
- **[Agent Module README](../../aiecs/domain/agent/README.md)** - Module overview and quick start
- **[Agent Examples](../../aiecs/domain/agent/EXAMPLES.md)** - Module-level examples
- **[Knowledge Graph Agent Integration](../knowledge_graph/agent/AGENT_INTEGRATION.md)** - Knowledge graph integration
- **[OpenSpec Proposal](../../openspec/changes/enhance-hybrid-agent-flexibility/proposal.md)** - Feature proposal and design
